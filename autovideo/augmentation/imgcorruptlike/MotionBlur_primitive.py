...
class MotionBlurPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Wrapper around MotionBlur().
    """

    metadata = construct_primitive_metadata("augmentation", "imgcorruptlike_MotionBlur")
    ...
    def _get_function(self):
        ...
        return iaa.MotionBlur(severity=severity,seed=seed)