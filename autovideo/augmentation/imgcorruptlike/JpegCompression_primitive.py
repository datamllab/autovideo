...
class JpegCompressionPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Wrapper around JpegCompression().
    """

    metadata = construct_primitive_metadata("augmentation", "imgcorruptlike_JpegCompression")
    ...
    def _get_function(self):
        ...
        return iaa.JpegCompression(severity=severity,seed=seed)