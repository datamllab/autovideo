...
__all__ = ('CropToMultiplesOfPrimitive',)
...
class CropToMultiplesOfPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which crop images until their height/width is a multiple of a value.
    """

    metadata = construct_primitive_metadata("augmentation", "size_CropToMultiplesOf")
    ...
    def _get_function(self):
        ...
        return iaa.CropToMultiplesOf(width_multiple = width_multiple,height_multiple =height_multiple,position = position, seed=seed)
