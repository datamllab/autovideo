...
__all__ = ('PadToPowersOfPrimitive',)
...
class PadToPowersOfPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Crop images until their height/width is a power of a base.
    """

    metadata = construct_primitive_metadata("augmentation", "size_PadToPowersOf")
    ...
    def _get_function(self):
        ...
        return iaa.PadToPowersOf(width_base = width_base,height_base=height_base,position = position, seed=seed)
