...
__all__ = ('CropToPowersOfPrimitive',)
...
class CropToPowersOfPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Crop images until their height/width is a power of a base.
    """

    metadata = construct_primitive_metadata("augmentation", "size_CropToPowersOf")
