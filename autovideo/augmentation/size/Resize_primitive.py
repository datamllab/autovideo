...
class ResizePrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which pad images to a predefined minimum width and/or height.
    """

    metadata = construct_primitive_metadata("augmentation", "size_Resize")
