...
__all__ = ('PadToFixedSizePrimitive',)
...
class PadToFixedSizePrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which pad images to a predefined minimum width and/or height.
    """

    metadata = construct_primitive_metadata("augmentation", "size_PadToFixedSize")
    ...
    def _get_function(self):
        ...
        return iaa.PadToFixedSize(width = width,height=height,position = position, seed=seed)
