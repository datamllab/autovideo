...
__all__ = ('PadToAspectRatioPrimitive',)
...
class PadToAspectRatioPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Pad images until their width/height matches an aspect ratio.
    """

    metadata = construct_primitive_metadata("augmentation", "size_PadToAspectRatio")
    ...
    def _get_function(self):
        ...
        return iaa.PadToAspectRatio(aspect_ratio = aspect_ratio,position = position, seed=seed)
