...
__all__ = ("OneOfPrimitive")


class Hyperparams(hyperparams.Hyperparams):
    pass

class OneOfPrimitive(transformer.TransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):

    metadata = construct_primitive_metadata("augmentation", "meta_OneOf")
    ...
    def produce(self, *, inputs: Inputs, timeout: float = None, iterations: int = None) -> base.CallResult[Outputs]:
        ...
        function = iaa.OneOf(children=augmentors)
        aug = [function]
