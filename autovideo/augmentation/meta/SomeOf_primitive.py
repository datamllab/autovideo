...
class SomeOfPrimitive(transformer.TransformerPrimitiveBase[Inputs, Outputs, Hyperparams]):

    metadata = construct_primitive_metadata("augmentation", "meta_SomeOf")
    ...
    def produce(self, *, inputs: Inputs, timeout: float = None, iterations: int = None) -> base.CallResult[Outputs]:
        ...
        function = iaa.SomeOf(n = self.hyperparams["n"], children=augmentors, random_order = self.hyperparams["random_order"])
        aug = [function]
