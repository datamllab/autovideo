...
class GrayscalePrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Augmenter to convert images to their grayscale versions.
    """

    metadata = construct_primitive_metadata("augmentation", "color_Grayscale")
    ...
    def _get_function(self):
        ...
        return iaa.Grayscale(alpha=alpha, seed=seed)
