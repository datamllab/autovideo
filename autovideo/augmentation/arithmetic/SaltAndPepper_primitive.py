...
__all__ = ('SaltAndPepperPrimitive',)
...
class Hyperparams(hyperparams.Hyperparams):
    ...
    p = hyperparams.Hyperparameter[typing.Union[float,tuple,list]](
        default=(0.0,0.03),
        description='Probability of replacing a pixel to salt/pepper noise.',
        semantic_types=['https://metadata.datadrivendiscovery.org/types/ControlParameter'],
    )
...
class SaltAndPepperPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Replace pixels in images with salt noise, i.e. white-ish pixels.
    """

    metadata = construct_primitive_metadata("augmentation", "arithmetic_SaltAndPepper")
    ...
    def _get_function(self):
        ...
        return iaa.SaltAndPepper(p=p,seed=seed,per_channel=per_channel)