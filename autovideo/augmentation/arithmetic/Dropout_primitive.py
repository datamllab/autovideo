...
class DropoutPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Augmenter that sets a certain fraction of pixels in images to zero.
    """

    metadata = construct_primitive_metadata("augmentation", "arithmetic_Dropout")
