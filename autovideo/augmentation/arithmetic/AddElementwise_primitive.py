...
__all__ = ('AddElementwisePrimitive',)
...
class AddElementwisePrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Add values to the pixels of images with possibly different values for neighbouring pixels.
    """

    metadata = construct_primitive_metadata("augmentation", "arithmetic_AddElementwise")
    ...
    def _get_function(self):
        ...
        return iaa.AddElementwise(value=value, per_channel=per_channel, seed=seed)