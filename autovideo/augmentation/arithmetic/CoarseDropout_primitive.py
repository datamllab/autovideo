...
__all__ = ('CoarseDropoutPrimitive',)
...
class CoarseDropoutPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Augmenter that sets rectangular areas within images to zero.
    """

    metadata = construct_primitive_metadata("augmentation", "arithmetic_CoarseDropout")
