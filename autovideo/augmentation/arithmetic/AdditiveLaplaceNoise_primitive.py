...
__all__ = ('AdditiveLaplaceNoisePrimitive',)
...
class AdditiveLaplaceNoisePrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Add noise sampled from laplace distributions elementwise to images.
    """

    metadata = construct_primitive_metadata("augmentation", "arithmetic_AdditiveLaplaceNoise")
