...
__all__ = ('MultiplyElementwisePrimitive',)
...
class MultiplyElementwisePrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Multiply values of pixels with possibly different values for neighbouring pixels, making each pixel darker or brighter.
    """

    metadata = construct_primitive_metadata("augmentation", "arithmetic_MultiplyElementwise")
    ...
    def _get_function(self):
        ...
        return iaa.MultiplyElementwise(mul=mul, per_channel=per_channel, seed=seed)