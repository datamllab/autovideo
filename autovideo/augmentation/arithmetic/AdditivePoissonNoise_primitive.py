...
__all__ = ('AdditivePoissonNoisePrimitive',)
...
class AdditivePoissonNoisePrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Add noise sampled from poisson distributions elementwise to images.
    """

    metadata = construct_primitive_metadata("augmentation", "arithmetic_AdditivePoissonNoise")
