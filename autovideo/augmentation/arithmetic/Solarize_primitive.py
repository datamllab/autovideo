...
class SolarizePrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Invert all values above a threshold in images.
    """

    metadata = construct_primitive_metadata("augmentation", "arithmetic_Solarize")
    ...
    def _get_function(self):
        ...
        return iaa.Solarize(p=p,threshold=threshold,seed=seed,min_value=min_value,max_value=max_value,invert_above_threshold=invert_above_threshold,per_channel=per_channel)