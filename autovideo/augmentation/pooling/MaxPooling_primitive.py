...
class MaxPoolingPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Apply max pooling to images.
    """

    metadata = construct_primitive_metadata("augmentation", "pooling_MaxPooling")
    ...
    def _get_function(self):
        ...
        return iaa.MaxPooling(kernel_size=kernel_size,keep_size=keep_size,seed=seed)