...
__all__ = ('AveragePoolingPrimitive',)
...
class AveragePoolingPrimitive(AugmentationPrimitiveBase[Inputs, Hyperparams]):
    """
    A primitive which Apply average pooling to images.
    """

    metadata = construct_primitive_metadata("augmentation", "pooling_AveragePooling")
    ...
    def _get_function(self):
        ...
        return iaa.AveragePooling(keep_size=keep_size,kernel_size=kernel_size,seed=seed)