...
def argsparser():
    ...
    parser.add_argument('--data_dir', help='The path of CSV file', type=str, default='datasets/Kinetics/')
...
def run(args):
   ...
   #train_table_path = os.path.join(args.data_dir, 'val.csv')
    train_table_path = os.path.join(args.data_dir, 'final_train.csv')
    ...
    import torch
    torch.save(fitted_pipeline, args.save_path, pickle_module=dill)
